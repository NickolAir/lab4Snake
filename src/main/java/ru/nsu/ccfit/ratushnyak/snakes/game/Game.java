...
import ru.nsu.ccfit.ratushnyak.snakes.game.check.Cell;
import ru.nsu.ccfit.ratushnyak.snakes.game.check.CellType;
...
import ru.nsu.ccfit.ratushnyak.snakes.game.snake.Snake;
    ...
    private void generateFruits() {
        ...
        while (fruits.size() < requiredFruitsNumber) {
            Cell randomEmptyCell = field.findRandomEmptyCell()
                    .orElseThrow(() -> new IllegalStateException("Cant find empty check"));
