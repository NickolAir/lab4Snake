...
import ru.nsu.ccfit.ratushnyak.snakes.game.GameObservable;
import ru.nsu.ccfit.ratushnyak.snakes.game.GameObserver;
import ru.nsu.ccfit.ratushnyak.snakes.game.GameState;
import ru.nsu.ccfit.ratushnyak.snakes.connections.gamelistchecker.GameInfo;
import ru.nsu.ccfit.ratushnyak.snakes.connections.gamelistchecker.GameListChecker;
import ru.nsu.ccfit.ratushnyak.snakes.connections.gamelistchecker.GameListObservable;
import ru.nsu.ccfit.ratushnyak.snakes.connections.gamelistchecker.GameListObserver;
...
import ru.nsu.ccfit.ratushnyak.snakes.connections.node.GameNode;
import ru.nsu.ccfit.ratushnyak.snakes.connections.node.MasterNode;
import ru.nsu.ccfit.ratushnyak.snakes.connections.node.NodeFactory;
...
public class MainNodeHandler implements NodeHandler, GameObservable, GameListObserver, GameListObservable {
    ...
    public void changeNodeRole(@NotNull Role nodeRole) {
        if (config == null) {
            logger.error("Cant change role={} to {} without configuration", this.nodeRole, nodeRole);
            exit();
            throw new IllegalStateException("Cant change role without configuration");
        }
        if (gameNode != null) {
            gameNode.stop();
        }
